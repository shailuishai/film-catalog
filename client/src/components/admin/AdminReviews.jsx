...
const AdminReviews = () => {
    const { users, films, reviews, fetchUsers, fetchFilms, fetchReviews, deleteReview, handleMultiDeleteReviews, handleCreateReview, handleUpdateReview } = useAdmin();
    ...
    useEffect(() => {
        ...
        fetchFilms().then(() => setIsLoading(false));
    }, []);
        ...
        <Box>
            ...
            {!reviews || reviews.length === 0 ? (
                <Text textAlign="center" fontSize="xl" mt={4}>
                    Пока нет отзывов. Хотите создать новый?
                </Text>
            ) : (
